...
@Service
public class ExpresspersonServiceImpl extends BaseServiceImpl<Expressperson> implements ExpresspersonService{
	 
	
	@Autowired
	private ExpresspersonMapper expresspersonMapper;
	@Override
	public BaseDao<Expressperson> getBaseDao() {
		return expresspersonMapper;
	}
