...
<div class="box2" panelTitle="查询" id="searchPanel">
    ...
    <form action="company/findByObj" id="queryForm" method="post">
...
<div style="height:35px;">
    ...
    <div class="float_right padding5">
        <pg:pager url="${ctx}/company/findByObj" maxIndexPages="5" items="${pagers.total}" maxPageItems="15"
