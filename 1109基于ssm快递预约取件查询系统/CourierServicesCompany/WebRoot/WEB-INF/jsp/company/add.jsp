...
<div class="box1" whiteBg="true">
    <form id="myFormId" action="company/exAdd" method="post" enctype="multipart/form-data">
        <table class="tableStyle" formMode="view">
            ...
            <tr>
                <td>资费：</td>
                <td colspan="2">
                    <input type="text" name="fy" class="validate[required,custom[onlyNumber]]"/>
                    <span class="star">*</span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>公司简介：</td>
                <td colspan="2">
                    <textarea name="bz" style="height: 200px"></textarea>
                    <span class="star">*</span>
                </td>
            </tr>
            <tr>
