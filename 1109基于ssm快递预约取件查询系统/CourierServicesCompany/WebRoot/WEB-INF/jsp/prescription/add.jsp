...
<div class="box1" whiteBg="true">
    <form id="myFormId" action="prescription/exAdd" method="post">
            ...
            <tr>
                ...
                <td>
                    <select selWidth="172" id="fjId" url="${ctx}/province/getProvinceList.json" prompt="请选择省份"
                            ...
                            selectedValue="" colNum="2" colWidth="200" name="provinceId" class="validate[required]">
                    </select>
                    <select selWidth="172" id="pcsId" name="cityId" prompt="选择城市" class="validate[required]"></select>
            ...
            <tr>
                ...
                <td>
                    <select selWidth="172" id="fjId2" url="${ctx}/province/getProvinceList.json" prompt="请选择省份"
                            ...
                            selectedValue="" colNum="2" colWidth="200" name="endProvinceId" class="validate[required]">
                    </select>
                    <select selWidth="172" id="pcsId2" name="endCityId"  prompt="选择城市" class="validate[required]"></select>
                    <span class="star">*</span>
                </td>
            </tr>
            <tr>
                <td>时间天数：</td>
                <td colspan="2">
                    <input type="text" name="time"  class="validate[required]"/>
                    <span class="star">*</span>
                </td>
            </tr>
            <tr>
                <td>金额（元/kg）：</td>
                <td colspan="2">
                    <input type="text" name="jg"  class="validate[required]"/>
                    <span class="star">*</span>
                </td>
            </tr>
            <tr>
