...
<div class="box2" panelTitle="查询" id="searchPanel">
    ...
    <form action="network/findByObj" id="queryForm" method="post">
        <table class="if_search_table">
            <tr>
                <td class="if_w80">公司名称：</td>
                <td class="if_w172">
                    <select selWidth="172" name="companyId" url="${ctx}/company/getCompanyList.json" prompt="选择公司" colNum="1" colWidth="200">
                    </select>
                </td>
                <td class="if_w80">网点名称：</td>
...
<div id="scrollContent" style="overflow-x:hidden;">
    <form id="myFormId" action="network/findByObj" method="post">
        ...
        <table class="tableStyle" mode="list">
            ...
            <tr>
                ...
                <td align="center">
                    <a onclick="onEdit('${row.network.id}')"><span style="color: gold;">修改</span></a>
                    <%--<a onclick="onDelete('${row.company.id}')"><span style="color: #00bd09">删除</span></a>--%>
                </td>
            </tr>
            </c:forEach>
        </table>
...
<div style="height:35px;">
    ...
    <div class="float_right padding5">
        <pg:pager url="${ctx}/network/findByObj" maxIndexPages="5" items="${pagers.total}" maxPageItems="15"
...
<script>
    //跳转到添加页面
    function onAdd() {
        window.location.href = "${ctx}/network/add";
    }

    // 修改
    function onEdit(id) {
        window.location.href = "${ctx}/network/edit?id=" + + id
    }
