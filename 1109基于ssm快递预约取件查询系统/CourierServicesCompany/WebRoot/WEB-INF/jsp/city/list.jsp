...
<div class="box2" panelTitle="查询" id="searchPanel">
    ...
    <form action="city/findByObj" id="queryForm" method="post">
        <table class="if_search_table">
            <tr>
                <td class="if_w80">城市名称：</td>
...
<div id="scrollContent" style="overflow-x:hidden;">
    <form id="myFormId" action="city/findByObj" method="post">
        ...
        <table class="tableStyle" mode="list">
            ...
            <tr>
                ...
                <td align="center">
                    <a onclick="onEdit('${row.city.id}')"><span style="color: gold;">修改</span></a>
                    <%--<a onclick="onDelete('${row.city.id}')"><span style="color: #00bd09">删除</span></a>--%>
                </td>
            </tr>
            </c:forEach>
        </table>
...
<div style="height:35px;">
    ...
    <div class="float_right padding5">
        <pg:pager url="${ctx}/city/findByObj" maxIndexPages="5" items="${pagers.total}" maxPageItems="15"
