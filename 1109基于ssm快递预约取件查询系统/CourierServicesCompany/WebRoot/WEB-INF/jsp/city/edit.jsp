...
<div class="box1" whiteBg="true">
    <form id="myFormId" action="city/exUpdate.json" method="post">
        <input type="hidden" name="id" value="${bean.id}"/>
        <table class="tableStyle" formMode="view">
            <tr>
                <td>选择省份：</td>
                <td>
                    <select selWidth="172" name="provinceId" url="${ctx}/province/getProvinceList.json" prompt="选择省份"
                            childId="provinceId" colNum="1" colWidth="200" selectedValue="${bean.provinceId}">
                    </select>
            </tr>
            <tr>
                <td>城市名称：</td>
