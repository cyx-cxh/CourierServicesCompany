...
<div class="box1" whiteBg="true">
    <form id="myFormId" action="users/exAdd" method="post">
        <table class="tableStyle" formMode="view">
            ...
            <tr>
                <td>真实姓名：</td>
                <td colspan="2">
                    <input type="text" name="realName" class="validate[required]"/>
                    <span class="star">*</span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>联系方式：</td>
                <td colspan="2">
                    <input type="text" name="phone" class="validate[required,custom[onlyNumber]]"/>
                </td>
            </tr>
            <tr>
                <td>输入密码：</td>
                <td colspan="2"><input type="password" id="pass" name="pass" class="validate[required]"/>
                    <span class="star">*</span>
                </td>
            </tr>
            <tr>
                <td>重复密码：</td>
                <td colspan="2"><input type="password" name="repass" class="validate[required,confirm[pass]]"/>
                    <span class="star">*</span>
                </td>
            </tr>
            <tr>
