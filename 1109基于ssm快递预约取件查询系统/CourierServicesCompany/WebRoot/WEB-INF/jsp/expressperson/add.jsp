...
<div class="box1" whiteBg="true">
    <form id="myFormId" action="expressperson/exAdd" method="post">
        <table class="tableStyle" formMode="view">
            ...
            <tr>
                <td>登录密码：</td>
                <td colspan="2">
                    <input type="text" name="pw" class="validate[required]"/>
                    <span class="star">*</span>
                </td>
            </tr>
            <tr>
                ...
                <td class="if_w172">
                    <select selWidth="172" id="fjId" url="${ctx}/company/getCompanyList.json" prompt="请选择公司"
                            ...
                            selectedValue="" colNum="2" colWidth="200" name="companyId">
                    </select>
                </td>
            </tr>
            <tr>
